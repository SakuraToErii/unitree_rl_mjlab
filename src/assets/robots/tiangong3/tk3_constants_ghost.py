"""TienKung 3 29-DoF Ghost robot asset and actuator configuration."""
...
def get_spec(*, convex_sole: bool = True) -> mujoco.MjSpec:
  """Return a fresh Ghost spec, using convex soles by default."""
...
def get_tk3_robot_cfg(*, convex_sole: bool = True) -> EntityCfg:
