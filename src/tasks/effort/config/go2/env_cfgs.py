...
def unitree_go2_rough_env_cfg(
  ...
  cfg.scene.entities = {"robot": get_go2_effort_robot_cfg()}
...
def unitree_go2_rough_mha_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  """Create the Go2 rough-terrain effort task with five-frame MHA history."""
  return enable_mha_history(unitree_go2_rough_env_cfg(play=play))


def unitree_go2_flat_mha_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  """Create the Go2 flat-terrain effort task with five-frame MHA history."""
  return enable_mha_history(unitree_go2_flat_env_cfg(play=play))
