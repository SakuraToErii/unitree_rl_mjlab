...
def unitree_g1_23dof_rough_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  ...
  cfg.scene.entities = {"robot": get_g1_23dof_effort_robot_cfg()}
...
def unitree_g1_23dof_rough_mha_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  """Create the G1-23DOF rough-terrain effort task with five-frame MHA history."""
  return enable_mha_history(unitree_g1_23dof_rough_env_cfg(play=play))


def unitree_g1_23dof_flat_mha_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  """Create the G1-23DOF flat-terrain effort task with five-frame MHA history."""
  return enable_mha_history(unitree_g1_23dof_flat_env_cfg(play=play))
