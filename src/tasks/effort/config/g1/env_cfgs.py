...
from src.tasks.effort.config.g1.action_cfg import g1_residual_effort_action_cfg
from src.tasks.effort.config.g1.robot_cfg import get_g1_effort_robot_cfg
from src.tasks.effort.velocity_env_cfg import enable_mha_history, make_effort_env_cfg


def unitree_g1_rough_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  """Create Unitree G1 rough terrain residual-effort configuration."""
...
def unitree_g1_flat_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  """Create Unitree G1 flat terrain residual-effort configuration."""
...
def unitree_g1_rough_mha_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  ...
  return enable_mha_history(unitree_g1_rough_env_cfg(play=play))
