"""Effort-controlled velocity task configuration.

This module provides a factory function to create a base 0pd torque task config.
...
def make_effort_env_cfg() -> ManagerBasedRlEnvCfg:
  """Create base effort-controlled velocity tracking task configuration."""
  ...
  curriculum = {
    ...
    "command_vel": CurriculumTermCfg(
      ...
      params={
        "command_name": "twist",
        "velocity_stages": [
          {"step": 0, "lin_vel_x": (-0.5, 0.5), "lin_vel_y": (-0.5, 0.5), "ang_vel_z": (-1.0, 1.0)},
          {"step": 10000 * 24, "lin_vel_x": (-1.5, 1.5), "lin_vel_y": (-1.0, 1.0)},
          {"step": 15000 * 24, "lin_vel_x": (-2.0, 2.0)},
        ],
      },
    ),
  }
...
def enable_mha_history(cfg: ManagerBasedRlEnvCfg) -> ManagerBasedRlEnvCfg:
